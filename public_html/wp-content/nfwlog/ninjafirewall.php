...
// WordPress dashboard.                                           //
// ===============================================================//
if ( file_exists('/home/walkforg/public_html/wp-content/plugins/ninjafirewall/lib/firewall.php') ) {
	@include_once '/home/walkforg/public_html/wp-content/plugins/ninjafirewall/lib/firewall.php';
}
// EOF
